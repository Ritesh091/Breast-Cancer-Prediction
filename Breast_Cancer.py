...
diagnosisAll = csv_data.shape[0]
diagnosisCategories = csv_data['diagnosis'].value_counts()
print(diagnosisCategories)

featuresMean = csv_data.columns[1:11]
...
print("SVC Cross validation score: {0:.2%}".format(np.mean(scores)))
...
print("NuSVC Cross validation score:{0:.2%}".format(np.mean(scores)))
...
print("LinearSVC Cross validation score: {0:.2%}".format(np.mean(scores)))
...
print("Radnom Forest Cross validation score: {0:.2%}".format(np.mean(scores)))
...
cv_selected_features.append(np.mean(scores))
print("Random Forest Accuracy: {0:.2%}".format(accuracy_score(prediction, y_test)))
print("Random Forest Cross validation score: {0:.2%}".format(np.mean(scores)))
